...
<div class="row">
	<div class="col">
	        <ul class="nav flex-column">
	          <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted">회원등록</a></li>
	          <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted">회원조회</a></li>
	          <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted">회원수정</a></li>
	          <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted">회원삭제</a></li>
	        </ul>
	</div>
